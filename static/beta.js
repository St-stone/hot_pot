...
a1.src = "https://hotpot.guaichi.repl.co/static/music/music.mp3";
const a3 = document.createElement("audio");
a3.src = "https://hotpot.guaichi.repl.co/static/music/idai.mp3";
const a5 = document.createElement("audio");
const a6 = document.createElement("audio");
a6.src = "https://hotpot.guaichi.repl.co/static/music/haachama_scary.mp3";
function main_music(){
  a1.play();
}
function play_music(){
...
function the_game_start(){
  ...
  eat = 0;
  m=0;
  document.getElementById('diff').innerHTML = "基礎關卡";
...
function haachamachama(){
  ...
  dif = -1;
  a1.pause();
  a5.src = "https://hotpot.guaichi.repl.co/static/music/haachama.mp3";
  a5.play();
  var ha_speed = speed,ha_which_item = which_item,ha_img_link = img_link,ha_title=document.getElementById('diff').innerHTML;
  ...
  setTimeout(
    function(){
      ...
      document.getElementById("hotpot").src=hotpot_img[0];
      document.getElementById('diff').innerHTML = ha_title;
      document.getElementById('the_big_title').innerHTML = "統神「接」火鍋(Beta測試版)";
...
function play(){
  ...
  if(point>=50&&dif<=0&&m==0){
    //speed_up ver 100
    document.getElementById('diff').innerHTML = "微加速關卡";
    speed = [[1,1,1],[3,2,5],[2,3,-1],[1,1,10]];
    which_item = [[23],[0,15],[16,20],[21,22]];
    dif = 1;
    haachama();
  }
  if(point>=100&&dif<=1&&m==0){
    document.getElementById('diff').innerHTML = "少量三色豆關卡";
    //more ver 500
    speed = [[1,1,1],[3,2,5],[2,3,-1],[1,1,10]];
  ...
  if(point>=150&&dif<=2&&m==0){
    document.getElementById('diff').innerHTML = "冰冰姐關卡";
    //All +5 ver 1000
  ...
  if(point>=200&&dif<=3&&m==0){
    document.getElementById('diff').innerHTML = "冰冰姐與三色豆關卡";
    //+5 and die ver 1200
  ...
  if(point>=250&&dif<=4&&m==0){
    document.getElementById('diff').innerHTML = "全部等速關卡";
  ...
  if(point>=300&&dif<=5&&m==0){
    document.getElementById('diff').innerHTML = "大量三色豆關卡";
  ...
  if(point>=350&&dif<=6&&m==0){
    document.getElementById('diff').innerHTML = "中速關卡";
    //explosion ver 3000
  ...
  if(point>=400&&dif<=7&&m==0){
    document.getElementById('diff').innerHTML = "快速關卡";
    //computer? ver 5000
  ...
  if(point>=450&&dif<=8&&m==0){
    document.getElementById('diff').innerHTML = "魔王關卡";
    //computer? ver 5000
  ...
  if(point>=500&&point>=(dif+1)*50&&dif<=(point/50)&&m==0){
    speed = [[2,1,1],[2,1,5],[2,1,-1],[1,1,10]];
    which_item = [[21],[0,5],[6,10],[11,20]];
    haachama();
    dif = point/50;
        ...
        if((con-4<=(i*4)+1&&(i+1)*4<=con+4)||((i*4)+1<=con-4&&con-4<=(i+1)*4)||((i*4)+1<=con+4&&con+4<=(i+1)*4)){
          if(speed[items[i][0]][2]>0||speed[items[i][0]][2]==-100){
            if(items[i][0]==1&&m==0){
              ...
              a2.src = "https://hotpot.guaichi.repl.co/static/music/only_today.mp3";
              A_today++;
              a2.play();
              ...
              a4.src = "https://hotpot.guaichi.repl.co/static/music/touch.mp3";
              A_food++;
              a4.play();
              point+=speed[items[i][0]][2];
              eat = 1;
